...
public class SlotHalloween extends JFrame implements ActionListener {
	...
	private void cargarSlot() {
		...
		int totalBruja = 0, totalBrujo = 0, totalCalabaza = 0, totalMurcielago = 0, totalVampiro = 0, totalZombi = 0,
				totalPayaso = 0, totalCalavera = 0, totalFantasma = 0, totalCuchillo = 0;
