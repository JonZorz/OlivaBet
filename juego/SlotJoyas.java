...
public class SlotJoyas extends JFrame implements ActionListener {
	...
	private void cargarSlot() {
		...
		int totalBillete = 0, totalBolsa = 0, totalMoneda = 0, totalAnillo = 0, totalDiamante = 0, totalColgante = 0,
				totalK = 0, totalDiez = 0, totalTrompeta = 0, totalCorona = 0;
